...
import Hdua from '../../components/custommdx/h2.astro'
import Hsatu from '../../components/custommdx/h1.astro'
import Teks from '../../components/custommdx/text.astro'
import Image from '../../components/custommdx/img.astro'

export const components = {h2: Hdua, h1: Hsatu, p: Teks, img: Image}
